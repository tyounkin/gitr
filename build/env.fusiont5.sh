...
export LIBCONFIGPPLIB=$LIBCONFIGDIR/lib/libconfig++.so
export LIBCONFIGLIB=$LIBCONFIGDIR/lib/libconfig.so
export LIBCONFIGPPLIB_STATIC=$LIBCONFIGDIR/lib/libconfig++.a
export LIBCONFIGLIB_STATIC=$LIBCONFIGDIR/lib/libconfig.a
